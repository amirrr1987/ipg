<template>
  <Form layout="vertical">
    <FormItem :label="`شماره کارت ${cardStore.bank.label}`">
      <Input
        v-maska
        data-maska="#### #### #### ####"
        size="large"
        class="w-full ltr text-xl h-14 text-left"
      />
    </FormItem>
    <FormItem label="شماره شناسایی دوم (CVV2)">
      <Input
        ...
        size="large"
        class="w-full ltr text-xl h-14 text-center"
      />
    </FormItem>
    ...
    <FormItem label="رمز دوم">
      <div class="grid grid-cols-2 gap-8">
        <Input type="password" size="large" class="w-full ltr text-xl h-14 text-left" />
        <Button type="primary" size="large" class="!h-14">درخواست رمز دوم</Button>
      </div>
    </FormItem>
    <FormItem label="ایمیل یا شماره تلفن همراه">
      <Input size="large" class="w-full ltr text-xl h-14 text-left" />
    </FormItem>
    <FormItem>
      <div class="grid grid-cols-2 gap-8">
